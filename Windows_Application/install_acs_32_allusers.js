...
function createFileAssociations() {
  ...
  if (0 != retcode) {
    install_log.writeline("File associations NOT cleared successfully.");
    acs_rtncode = retcode;
  }
  ...
  if (0 == retcode) {
    ...
    install_log.writeline("File associations NOT created.");
    acs_rtncode = retcode;
  }
}
...
\n\
Syntax:\n\
  install_acs_32.js [/Exclude=<function1,function2,...> | /Reset | /C | /Q | /R | /CQ | /CQR | /CR | /QR]\n\
...
function kill_daemon() {
  ...
  if (0 != retcode) {
    install_log.writeline("Reset for Maintenance failed.");
    acs_rtncode = retcode;
  }
}
...
If Access Client Solutions does not start, install the latest Java 8 or Java 11.";
    }
